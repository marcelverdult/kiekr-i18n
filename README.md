...
|----------------|------|-----------:|------:|----------:|------------|
| English        | `en` |       100% |  1520 |         0 | kiekr-team |
| Deutsch        | `de` |       100% |  1520 |         0 | kiekr-team |
| Español        | `es` |       100% |  1279 |       241 | community  |
| Français       | `fr` |       100% |  1279 |       241 | community  |
| Nederlands     | `nl` |       100% |  1279 |       241 | community  |
| Italiano       | `it` |       100% |  1365 |       155 | community  |
| Português (Brasil) | `pt-BR` |       100% |     1 |      1519 | community  |
| Polski         | `pl` |       100% |    11 |      1509 | community  |
| Български      | `bg` |       100% |     0 |      1520 | community  |
| Čeština        | `cs` |       100% |     0 |      1520 | community  |
| Dansk          | `da` |       100% |     0 |      1520 | community  |
| Ελληνικά       | `el` |       100% |     0 |      1520 | community  |
| Eesti          | `et` |       100% |     0 |      1520 | community  |
| Suomi          | `fi` |       100% |     0 |      1520 | community  |
| Gaeilge        | `ga` |       100% |     0 |      1520 | community  |
| Hrvatski       | `hr` |       100% |     0 |      1520 | community  |
| Magyar         | `hu` |       100% |     0 |      1520 | community  |
| Lietuvių       | `lt` |       100% |     0 |      1520 | community  |
| Latviešu       | `lv` |       100% |     0 |      1520 | community  |
| Malti          | `mt` |       100% |     0 |      1520 | community  |
| Norsk bokmål   | `nb` |       100% |     0 |      1520 | community  |
| Português (Portugal) | `pt-PT` |       100% |     0 |      1520 | community  |
| Română         | `ro` |       100% |     0 |      1520 | community  |
| Русский        | `ru` |       100% |     0 |      1520 | community  |
| Slovenčina     | `sk` |       100% |     0 |      1520 | community  |
| Slovenščina    | `sl` |       100% |     0 |      1520 | community  |
| Svenska        | `sv` |       100% |     0 |      1520 | community  |
| Українська     | `uk` |       100% |     0 |      1520 | community  |
