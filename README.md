...
|----------------|------|-----------:|------:|----------:|------------|
| English        | `en` |       100% |  1501 |         0 | kiekr-team |
| Deutsch        | `de` |       100% |  1501 |         0 | kiekr-team |
| Español        | `es` |       100% |  1279 |       222 | community  |
| Français       | `fr` |       100% |  1279 |       222 | community  |
| Nederlands     | `nl` |       100% |  1279 |       222 | community  |
| Italiano       | `it` |       100% |  1365 |       136 | community  |
| Português (Brasil) | `pt-BR` |       100% |     1 |      1500 | community  |
| Polski         | `pl` |       100% |    11 |      1490 | community  |
| Български      | `bg` |       100% |     0 |      1501 | community  |
| Čeština        | `cs` |       100% |     0 |      1501 | community  |
| Dansk          | `da` |       100% |     0 |      1501 | community  |
| Ελληνικά       | `el` |       100% |     0 |      1501 | community  |
| Eesti          | `et` |       100% |     0 |      1501 | community  |
| Suomi          | `fi` |       100% |     0 |      1501 | community  |
| Gaeilge        | `ga` |       100% |     0 |      1501 | community  |
| Hrvatski       | `hr` |       100% |     0 |      1501 | community  |
| Magyar         | `hu` |       100% |     0 |      1501 | community  |
| Lietuvių       | `lt` |       100% |     0 |      1501 | community  |
| Latviešu       | `lv` |       100% |     0 |      1501 | community  |
| Malti          | `mt` |       100% |     0 |      1501 | community  |
| Norsk bokmål   | `nb` |       100% |     0 |      1501 | community  |
| Português (Portugal) | `pt-PT` |       100% |     0 |      1501 | community  |
| Română         | `ro` |       100% |     0 |      1501 | community  |
| Русский        | `ru` |       100% |     0 |      1501 | community  |
| Slovenčina     | `sk` |       100% |     0 |      1501 | community  |
| Slovenščina    | `sl` |       100% |     0 |      1501 | community  |
| Svenska        | `sv` |       100% |     0 |      1501 | community  |
| Українська     | `uk` |       100% |     0 |      1501 | community  |
